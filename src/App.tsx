    ...
    <>
      ...
      <div className="page-content">
        ...
        <section className="footer">
          <svg className="question-icon" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="copy">Learn about <a href="https://www.apollographql.com/docs/react/">Apollo Client</a>, <a href="https://www.apollographql.com/docs/apollo-server/">Apollo Server</a>, and <a href="https://www.apollographql.com/docs/studio/">Apollo Studio</a></span>.
        </section>
